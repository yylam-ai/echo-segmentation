...
def preprocess_data(input_path, output_path, save_kpts, save_imgs, view, img_size):
    ...
    volume_tracings_path = os.path.join(input_path, 'VolumeTracings_v3.csv')
    ...
    anno_folder = os.path.join(output_path, "annotations")
    frames_cycle_folder = os.path.join(output_path, "cycle/frames")
    anno_cycle_folder = os.path.join(output_path, "cycle/annotations")
